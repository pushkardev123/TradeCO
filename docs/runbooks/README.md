...
| [Order Command Processing and Redis Streams](order-command-processing-and-redis-streams.md) | Backend producer, execution consumer, Redis smoke, market-order vertical-slice smoke, and recovery commands documented | Backend and execution owners | Diagnose command processing and Redis Stream stuck-message handling. |
